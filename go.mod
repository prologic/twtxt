...
require (
	...
	github.com/abusizhishen/read-file-last-line v0.0.0-20200717025516-5bf8361f20a5
	...
	github.com/prologic/read-file-last-line v0.0.0-20200805221103-a60375b5e037
